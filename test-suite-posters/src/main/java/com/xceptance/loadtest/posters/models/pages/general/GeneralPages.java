...
import com.xceptance.loadtest.posters.models.components.general.WishList;
...
public class GeneralPages extends Page
{
    ...
    public WishList wishlist = WishList.instance;
    ...
    {
        validate(has(header, user, miniCart, search, navigation, wishlist, footer));
    }

    @Override
    public boolean is()
    {
        return matches(has(header, miniCart, search, navigation,wishlist, footer));
    }
}