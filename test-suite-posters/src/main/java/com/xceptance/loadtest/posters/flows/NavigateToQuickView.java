...
public class NavigateToQuickView extends Flow
{
    
    boolean Searchorder=false;
    public NavigateToQuickView(boolean Search)
	{
    ...
    private boolean viewProduct() throws Throwable
    {
        ...
        int QuickviewCount = Context.configuration().productViewCount.random();
