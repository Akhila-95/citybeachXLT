...
/**
 * Starts visit at landing page, browses categories or searches, executes
 * product listing page actions, visits product pages, configures products, adds
 * to cart and views the cart page.
 * 
