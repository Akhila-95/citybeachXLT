...
public class Account implements Initable
{
     ...
     * Prod Url
     */
    @Property(key = "prodUrl", required = false)
     ...
     * Date of birth
     */
    @Property(key = "Dob", required = false)
    public String Dob;
    /**
     * Mobile Number
     */
    @Property(key = "mobile", required = false)
     ...
     *addressTitile.
     */
    @Property(key = "addressTitile", required = false)
    public String addressTitile;
    ...
    /**
     * PickupAtStore address.
     */
    @Property(key = "pickupatstore", required = false)
    public Address PickupAtStore;
    

    /**
     * payment State Data.
     */
    @Property(key = "Statedata", required = false)
    public String PaymentStatedata;
